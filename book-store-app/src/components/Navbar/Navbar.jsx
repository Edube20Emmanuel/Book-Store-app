          ...
          >
            ...
            <ul className="items-center gap-4 hidden sm:flex">
              ...
              <li className="group relative cursor-pointer">
                ...
                text-black bg-white p-2 shadow-md w-[150px]"
                >
                  <ul>
            ...
            text-white px-4 py-1 rounded-full flex
            items-center gap-3 hover:scale-105 duration-300"
            >
              Order
              <FaCartShopping
